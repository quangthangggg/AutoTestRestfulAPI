...
public class GetListAuctionsByType extends APINeedTesting{
	...
	void test1() {
		System.out.println("Test 1 in GetListAuctionsByType API: The code should be 1000 and message is OK when passing correctly");
		...
		//End
		System.out.println("Finish Test 1 in GetListAuctionsByType");
	}

	public static void main(String[] args) {
		GetListAuctionsByType g = new GetListAuctionsByType();
		g.test1();
	}
}
